...
function ja(a,b){a.prototype=aa(b.prototype);a.prototype.constructor=a;if(ia)ia(a,b);else for(var c in b)if(c!="prototype")if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.Ia=b.prototype}
...
function r(){this.A=!1;this.m=null;this.o=void 0;this.h=1;this.j=this.u=0;this.C=this.i=null}
function na(a){if(a.A)throw new TypeError("Generator is already running");a.A=!0}
r.prototype.B=function(a){this.o=a};
function oa(a,b){a.i={N:b,P:!0};a.h=a.u||a.j}
r.prototype.getNextAddressJsc=function(){return this.h};
r.prototype.getYieldResultJsc=function(){return this.o};
r.prototype.return=function(a){this.i={return:a};this.h=this.j};
r.prototype["return"]=r.prototype.return;r.prototype.K=function(a){this.i={D:a};this.h=this.j};
r.prototype.jumpThroughFinallyBlocks=r.prototype.K;r.prototype.v=function(a,b){this.h=b;return{value:a}};
r.prototype.yield=r.prototype.v;r.prototype.ba=function(a,b){a=q(a);var c=a.next();ma(c);if(c.done)this.o=c.value,this.h=b;else return this.m=a,this.v(c.value,b)};
r.prototype.yieldAll=r.prototype.ba;r.prototype.D=function(a){this.h=a};
r.prototype.jumpTo=r.prototype.D;r.prototype.L=function(){this.h=0};
r.prototype.jumpToEnd=r.prototype.L;r.prototype.Z=function(a,b){this.u=a;b!=void 0&&(this.j=b)};
r.prototype.setCatchFinallyBlocks=r.prototype.Z;r.prototype.aa=function(a){this.u=0;this.j=a||0};
r.prototype.setFinallyBlock=r.prototype.aa;r.prototype.Y=function(a,b){this.h=a;this.u=b||0};
r.prototype.leaveTryBlock=r.prototype.Y;r.prototype.H=function(a){this.u=a||0;a=this.i.N;this.i=null;return a};
r.prototype.enterCatchBlock=r.prototype.H;r.prototype.I=function(a,b,c){c?this.C[c]=this.i:this.C=[this.i];this.u=a||0;this.j=b||0};
r.prototype.enterFinallyBlock=r.prototype.I;r.prototype.X=function(a,b){b=this.C.splice(b||0)[0];(b=this.i=this.i||b)?b.P?this.h=this.u||this.j:b.D!=void 0&&this.j<b.D?(this.h=b.D,this.i=null):this.h=this.j:this.h=a};
r.prototype.leaveFinallyBlock=r.prototype.X;r.prototype.J=function(a){return new pa(a)};
r.prototype.forIn=r.prototype.J;function pa(a){this.j=a;this.h=[];for(var b in a)this.h.push(b);this.h.reverse()}
pa.prototype.i=function(){for(;this.h.length>0;){var a=this.h.pop();if(a in this.j)return a}return null};
pa.prototype.getNext=pa.prototype.i;function qa(a){this.h=new r;this.i=a}
function ra(a,b){na(a.h);var c=a.h.m;if(c)return sa(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.h.return);
a.h.return(b);return t(a)}
function sa(a,b,c,d){try{var l=b.call(a.h.m,c);ma(l);if(!l.done)return a.h.A=!1,l;var m=l.value}catch(f){return a.h.m=null,oa(a.h,f),t(a)}a.h.m=null;d.call(a.h,m);return t(a)}
function t(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.A=!1,{value:b.value,done:!1}}catch(c){a.h.o=void 0,oa(a.h,c)}a.h.A=!1;if(a.h.i){b=a.h.i;a.h.i=null;if(b.P)throw b.N;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
function ta(a){this.next=function(b){na(a.h);a.h.m?b=sa(a,a.h.m.next,b,a.h.B):(a.h.B(b),b=t(a));return b};
this.throw=function(b){na(a.h);a.h.m?b=sa(a,a.h.m["throw"],b,a.h.B):(oa(a.h,b),b=t(a));return b};
...
function c(m,f){this.h=m;ba(this,"description",{configurable:!0,writable:!0,value:f})}
...
return a}
p("Promise",function(a){function b(f){this.i=0;this.j=void 0;this.h=[];this.v=!1;var e=this.m();try{f(e.resolve,e.reject)}catch(g){e.reject(g)}}
function c(){this.h=null}
function d(f){return f instanceof b?f:new b(function(e){e(f)})}
if(a)return a;c.prototype.i=function(f){if(this.h==null){this.h=[];var e=this;this.j(function(){e.o()})}this.h.push(f)};
var l=h.setTimeout;c.prototype.j=function(f){l(f,0)};
c.prototype.o=function(){for(;this.h&&this.h.length;){var f=this.h;this.h=[];for(var e=0;e<f.length;++e){var g=f[e];f[e]=null;try{g()}catch(k){this.m(k)}}}this.h=null};
c.prototype.m=function(f){this.j(function(){throw f;})};
b.prototype.m=function(){function f(k){return function(n){g||(g=!0,k.call(e,n))}}
var e=this,g=!1;return{resolve:f(this.I),reject:f(this.o)}};
b.prototype.I=function(f){if(f===this)this.o(new TypeError("A Promise cannot resolve to itself"));else if(f instanceof b)this.K(f);else{a:switch(typeof f){case "object":var e=f!=null;break a;case "function":e=!0;break a;default:e=!1}e?this.H(f):this.u(f)}};
b.prototype.H=function(f){var e=void 0;try{e=f.then}catch(g){this.o(g);return}typeof e=="function"?this.L(e,f):this.u(f)};
b.prototype.o=function(f){this.A(2,f)};
b.prototype.u=function(f){this.A(1,f)};
b.prototype.A=function(f,e){if(this.i!=0)throw Error("Cannot settle("+f+", "+e+"): Promise already settled in state"+this.i);this.i=f;this.j=e;this.i===2&&this.J();this.B()};
b.prototype.J=function(){var f=this;l(function(){if(f.C()){var e=h.console;typeof e!=="undefined"&&e.error(f.j)}},1)};
b.prototype.C=function(){if(this.v)return!1;var f=h.CustomEvent,e=h.Event,g=h.dispatchEvent;if(typeof g==="undefined")return!0;typeof f==="function"?f=new f("unhandledrejection",{cancelable:!0}):typeof e==="function"?f=new e("unhandledrejection",{cancelable:!0}):(f=h.document.createEvent("CustomEvent"),f.initCustomEvent("unhandledrejection",!1,!0,f));f.promise=this;f.reason=this.j;return g(f)};
b.prototype.B=function(){if(this.h!=null){for(var f=0;f<this.h.length;++f)m.i(this.h[f]);this.h=null}};
var m=new c;b.prototype.K=function(f){var e=this.m();f.F(e.resolve,e.reject)};
b.prototype.L=function(f,e){var g=this.m();try{f.call(e,g.resolve,g.reject)}catch(k){g.reject(k)}};
...
this.F(g(f,k),g(e,n));return w};
b.prototype.catch=function(f){return this.then(void 0,f)};
b.prototype.F=function(f,e){function g(){switch(k.i){case 1:f(k.j);break;case 2:e(k.j);break;default:throw Error("Unexpected state: "+k.i);}}
var k=this;this.h==null?m.i(g):this.h.push(g);this.v=!0};
b.resolve=d;b.reject=function(f){return new b(function(e,g){g(f)})};
b.race=function(f){return new b(function(e,g){for(var k=q(f),n=k.next();!n.done;n=k.next())d(n.value).F(e,g)})};
...
var D=[],J=0;do D.push(void 0),J++,d(g.value).F(w(D.length-1),n),g=e.next();while(!g.done)})};
return b});
...
p("WeakMap",function(a){function b(g){this.h=(e+=Math.random()+1).toString();if(g){g=q(g);for(var k;!(k=g.next()).done;)k=k.value,this.set(k[0],k[1])}}
function c(){}
...
var f="$jscomp_hidden_"+Math.random();m("freeze");m("preventExtensions");m("seal");var e=0;b.prototype.set=function(g,k){if(!d(g))throw Error("Invalid WeakMap key");l(g);if(!v(g,f))throw Error("WeakMap key fail: "+g);g[f][this.h]=k;return this};
b.prototype.get=function(g){return d(g)&&v(g,f)?g[f][this.h]:void 0};
b.prototype.has=function(g){return d(g)&&v(g,f)&&v(g[f],this.h)};
b.prototype.delete=function(g){return d(g)&&v(g,f)&&v(g[f],this.h)?delete g[f][this.h]:!1};
return b});
...
b.prototype.keys=b.prototype.values;b.prototype[Symbol.iterator]=b.prototype.values;b.prototype.forEach=function(c,d){var l=this;this.h.forEach(function(m){return c.call(d,m,m,l)})};
return b});
...
;function B(a,b){this.h=b}
B.prototype.toString=function(){return this.h+""};
function C(a){var b=Ga();a=b?b.createScriptURL(a):a;return new B(z,a)}
function Ha(a){return a instanceof B}
function E(a){if(Ha(a))return a.h;throw Error("");}
;function F(a,b){this.h=b}
F.prototype.toString=function(){return this.h};
function G(a){return new F(z,a)}
var Ia=G("about:blank"),Ja=G("about:invalid#zClosurez");function Ka(a){return a instanceof F}
function La(a){if(Ka(a))return a.h;throw Error("");}
;function H(a){this.ga=a}
function I(a){return new H(function(b){return b.substr(0,a.length+1).toLowerCase()===a+":"})}
var K={za:I("tel"),ia:new H(function(a){return/^callto:\+?\d*$/i.test(a)}),
ya:new H(function(a){return a.indexOf("ssh://")===0}),
va:I("rtsp"),T:I("data"),V:I("http"),W:I("https"),EXTENSION:new H(function(a){return a.indexOf("chrome-extension://")===0||a.indexOf("moz-extension://")===0||a.indexOf("ms-browser-extension://")===0||a.indexOf("safari-web-extension://")===0}),
U:I("ftp"),da:new H(function(a){return/^[^:]*([/?#]|$)/.test(a)}),
ca:I("mailto"),pa:I("intent"),ua:I("market"),qa:I("itms"),ra:I("itms-appss"),sa:I("itms-services"),la:I("fb-messenger"),Ba:I("whatsapp"),wa:new H(function(a){return a.indexOf("sip:")===0||a.indexOf("sips:")===0}),
xa:I("sms"),Aa:I("vnd.youtube"),na:I("googlehome"),oa:I("googlehomesdk"),ta:I("line")},Ma=[K.T,K.V,K.W,K.ca,K.U,K.da];function Na(a,b){b=b===void 0?Ma:b;if(Ka(a))return a;for(var c=0;c<b.length;++c){var d=b[c];if(d instanceof H&&d.ga(a))return G(a)}}
function Oa(a){var b=window;if(typeof MediaSource!=="undefined"&&a instanceof MediaSource||typeof b.ManagedMediaSource!=="undefined"&&a instanceof b.ManagedMediaSource)return G(URL.createObjectURL(a));b=a.type;b.toLowerCase()==="application/octet-stream"?b=!0:(b=b.match(/^([^;]+)(?:;\w+=(?:\w+|"[\w;,= ]+"))*$/i),b=(b==null?void 0:b.length)===2&&(/^image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon|heic|heif|avif|x-ms-bmp)$/i.test(b[1])||/^video\/(?:3gpp|avi|mpeg|mpg|mp4|ogg|webm|x-flv|matroska|x-matroska|quicktime|x-ms-wmv)$/i.test(b[1])||
/^audio\/(?:3gpp2|3gpp|aac|amr|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|matroska|x-matroska|x-wav|wav|webm)$/i.test(b[1])||/^font\/[\w-]+$/i.test(b[1])));if(!b)throw Error("");return G(URL.createObjectURL(a))}
...
;function N(a,b){this.h=b}
N.prototype.toString=function(){return this.h+""};
...
function P(a){if(bb(a))return a.h;throw Error("");}
;function cb(a,b){a.src=E(b).toString()}
function Q(a,b){a.srcdoc=P(b)}
var db={ma:0,ja:1,ka:2,0:"FORMATTED_HTML_CONTENT",1:"EMBEDDED_INTERNAL_CONTENT",2:"EMBEDDED_TRUSTED_EXTERNAL_CONTENT"};function R(a,b){a.setAttribute("sandbox","");for(var c=0;c<b.length;c++)a.sandbox.supports&&!a.sandbox.supports(b[c])||a.sandbox.add(b[c])}
...
;function T(a,b){this.h=b}
T.prototype.toString=function(){return this.h+""};
...
function V(a){if(jb(a))return a.h;throw Error("");}
;function kb(a){var b=gb(a.ownerDocument);b&&a.setAttribute("nonce",b)}
function lb(a,b,c){a.src=E(b);(c==null?0:c.ha)||kb(a)}
;function mb(a,b){this.h=b}
mb.prototype.toString=function(){return this.h};
function nb(a){if(a instanceof mb)return a.h;throw Error("");}
...
;function X(a,b){if(bb(a))return a;a=Y(String(a));if(b==null?0:b.Fa)a=a.replace(/(^|[\r\n\t ]) /g,"$1&#160;");if(b==null?0:b.Ea)a=a.replace(/(\r\n|\n|\r)/g,"<br>");if(b==null?0:b.Ga)a=a.replace(/(\t+)/g,'<span style="white-space:pre">$1</span>');return O(a)}
...
;function Ib(){this.h=new Map}
Ib.prototype.format=function(a){var b=this,c=X("_safevalues_format_marker_:").toString();a=X(a).toString().replace(new RegExp("\\{"+c+"[\\w&#;]+\\}","g"),function(d){var l;if(l=b.h.get(d)){d="";switch(l.type){case "html":d=l.O;break;case "startTag":d="<"+l.tagName+l.attributes+">";break;case "endTag":d="</"+l.tagName+">"}l=d}else l=d;return l});
return O(a)};
Ib.prototype.text=function(a){a={type:"html",O:X(a).toString()};var b="{_safevalues_format_marker_:"+this.h.size+"_"+Math.random().toString(36).slice(2)+"}";this.h.set(X(b).toString(),a);return b};function Jb(a,b){var c=b.createRange();c.selectNode(b.body);a=O(a);return yb(c,a)}
;function Kb(a){a=a.nodeName;return typeof a==="string"?a:"FORM"}
function Lb(a){a=a.nodeType;return a===1||typeof a!=="number"}
;function Mb(a,b,c,d){var l=new Map(Nb);this.j=a;this.h=l;this.m=b;this.o=c;this.i=d}
function Ob(a,b,c){c=a.h.get(c);return(c==null?0:c.has(b))?c.get(b):a.m.has(b)?{l:1}:(c=a.o.get(b))?c:a.i&&[].concat(la(a.i)).some(function(d){return b.indexOf(d)===0})?{l:1}:{l:0}}
...
Nb=[["A",new Map([["href",{l:7}]])],["AREA",new Map([["href",{l:7}]])],["LINK",new Map([["href",{l:5,conditions:new Map([["rel",new Set("alternate author bookmark canonical cite help icon license next prefetch dns-prefetch prerender preconnect preload prev search subresource".split(" "))]])}]])],["SOURCE",new Map([["src",{l:5}],["srcset",{l:6}]])],["IMG",new Map([["src",{l:5}],["srcset",{l:6}]])],["VIDEO",new Map([["src",{l:5}]])],["AUDIO",new Map([["src",{l:5}]])]],Qb="title aria-atomic aria-autocomplete aria-busy aria-checked aria-current aria-disabled aria-dropeffect aria-expanded aria-haspopup aria-hidden aria-invalid aria-label aria-level aria-live aria-multiline aria-multiselectable aria-orientation aria-posinset aria-pressed aria-readonly aria-relevant aria-required aria-selected aria-setsize aria-sort aria-valuemax aria-valuemin aria-valuenow aria-valuetext alt align autocapitalize autocomplete autocorrect autofocus autoplay bgcolor border cellpadding cellspacing checked cite color cols colspan controls controlslist coords crossorigin datetime disabled download draggable enctype face formenctype frameborder height hreflang hidden inert ismap label lang loop max maxlength media minlength min multiple muted nonce open playsinline placeholder preload rel required reversed role rows rowspan selected shape size sizes slot span spellcheck start step summary translate type usemap valign value width wrap itemscope itemtype itemid itemprop itemref".split(" "),
Rb=[["dir",{l:3,conditions:y(function(){return new Map([["dir",new Set(["auto","ltr","rtl"])]])})}],
["async",{l:3,conditions:y(function(){return new Map([["async",new Set(["async"])]])})}],
["loading",{l:3,conditions:y(function(){return new Map([["loading",new Set(["eager","lazy"])]])})}],
["poster",{l:5}],["target",{l:3,conditions:y(function(){return new Map([["target",new Set(["_self","_blank"])]])})}]],Sb=new Mb(new Set(Pb),new Set(Qb),new Map(Rb)),Tb=new Mb(new Set(Pb.concat(["BUTTON",
"INPUT"])),new Set(y(function(){return Qb.concat(["class","id","name"])})),new Map(y(function(){return Rb.concat([["style",
{l:1}]])}))),Ub=new Mb(new Set(y(function(){return Pb.concat("STYLE TITLE INPUT TEXTAREA BUTTON LABEL".split(" "))})),new Set(y(function(){return Qb.concat(["class",
"id","tabindex","contenteditable","name"])})),new Map(y(function(){return Rb.concat([["style",
{l:1}]])})),new Set(["data-",
"aria-"]));function Vb(a){this.h=a}
...
function Xb(a,b,c){b=Jb(b,c);b=document.createTreeWalker(b,5,function(e){if(e.nodeType===3)e=1;else if(Lb(e))if(e=Kb(e),e===null)e=2;else{var g=a.h;e=e!=="FORM"&&(g.j.has(e)||g.h.has(e))?1:2}else e=2;return e});
...
ja(dc,cc);function ec(a){var b=a.split(/[?#]/),c=/[?]/.test(a)?"?"+b[1]:"";return{G:b[0],R:c,M:/[#]/.test(a)?"#"+(c?b[2]:b[1]):""}}
...
;var jc={0:1,1:1},kc={0:.1,1:.1};function lc(a,b){var c;if(!(c=!b)){var d,l;c=!(Math.random()<((l=(d=b.Ha)!=null?d:jc[b.S[0]])!=null?l:0))}if(c||window.SAFEVALUES_REPORTING===!1||!("DocumentFragment"in window))return a;var m,f;Math.random()<((f=(m=b.Da)!=null?m:kc[b.S[0]])!=null?f:0)&&mc(b,"HEARTBEAT");nc(a,b)||X(a).toString()!==a&&mc(b,"H_ESCAPE");return a}
...
function mc(a,b){(oc?oc:typeof window!=="undefined"&&window.navigator&&window.navigator.sendBeacon!==void 0?navigator.sendBeacon.bind(navigator):pc)("https://csp.withgoogle.com/csp/lcreport/"+a.S,JSON.stringify({host:window.location.hostname,type:b,additionalData:void 0}))}
...
x("safevalues_raw.scriptUrlToHtml",function(a,b){a=E(a).toString();a='<script src="'+Y(a)+'"';if(b==null?0:b.async)a+=" async";(b==null?void 0:b.attributionSrc)!==void 0&&(a+=' attributionsrc="'+Y(b.attributionSrc)+'"');if(b==null?0:b.fa)a+=' custom-element="'+Y(b.fa)+'"';if(b==null?0:b.defer)a+=" defer";if(b==null?0:b.id)a+=' id="'+Y(b.id)+'"';if(b==null?0:b.nonce)a+=' nonce="'+Y(b.nonce)+'"';if(b==null?0:b.type)a+=' type="'+Y(b.type)+'"';if(b==null?0:b.ea)a+=' crossorigin="'+Y(b.ea)+'"';return O(a+
">\x3c/script>")});
...
x("safevalues_raw.HtmlSanitizerBuilder",dc);x("safevalues_raw.appendParams",function(a,b){a=ec(E(a).toString());return fc(a.G,a.R,a.M,b)});
x("safevalues_raw.replaceParams",function(a,b){a=ec(E(a).toString());return fc(a.G,"",a.M,b)});
x("safevalues_raw.appendPathSegment",function(a,b){a=ec(E(a).toString());b=a.G+(a.G.slice(-1)==="/"?"":"/")+encodeURIComponent(b);return C(b+a.R+a.M)});
...
x("safevalues_raw.dom.setLinkWithResourceUrlHrefAndRel",rb);x("safevalues_raw.dom.setObjectData",fb);x("safevalues_raw.dom.setScriptSrc",lb);x("safevalues_raw.dom.setScriptTextContent",function(a,b,c){a.textContent=V(b);(c==null?0:c.ha)||kb(a)});
...
x("safevalues_raw.dom.fetchResourceUrl",function(a,b){var c,d,l,m,f;return xa(function(e){if(e.h==1)return e.v(fetch(E(a).toString(),b),2);c=e.o;f=(d=c.headers.get("Content-Type"))==null?void 0:(l=d.split(";",2))==null?void 0:(m=l[0])==null?void 0:m.toLowerCase();return e.return({O:function(){var g;return xa(function(k){if(k.h==1){if(f!=="text/html")throw new xb(c.url,"SafeHtml","text/html");return k.v(c.text(),2)}g=k.o;return k.return(O(g))})},
script:function(){var g;return xa(function(k){if(k.h==1){if(f!=="text/javascript"&&f!=="application/javascript")throw new xb(c.url,"SafeScript","text/javascript");return k.v(c.text(),2)}g=k.o;return k.return(U(g))})},
styleSheet:function(){var g;return xa(function(k){if(k.h==1){if(f!=="text/css")throw new xb(c.url,"SafeStyleSheet","text/css");return k.v(c.text(),2)}g=k.o;return k.return(W(g))})}})})});
